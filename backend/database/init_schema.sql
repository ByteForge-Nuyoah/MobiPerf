...
CREATE TABLE IF NOT EXISTS performance_metrics (
    ...
    fps INT COMMENT '帧率',
    jank_count INT COMMENT '卡顿次数',
    stutter_rate FLOAT COMMENT '卡顿率',
    battery_temp FLOAT COMMENT '电池温度',
    network_rx FLOAT COMMENT '网络下行(KB)',
    network_tx FLOAT COMMENT '网络上行(KB)',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS comments (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    session_id VARCHAR(100) NOT NULL COMMENT '测试会话ID',
